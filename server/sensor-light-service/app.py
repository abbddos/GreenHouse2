...
from models import LightSensorTable 
...
def get_all_readings(greenhouse_id):
    try:
        all_readings = LightSensorTable.query.filter(greenhouse_id = greenhouse_id).all()
...
def get_latest_reading(greenhouse_id):
    try:
        latest_reading = LightSensorTable.query.filter(greenhouse_id = greenhouse_id).order_by(LightSensorTable.timestamp.desc()).first()
