...
from models import WindSensorTable 
...
def get_all_readings(greenhouse_id):
    try:
        all_readings = WindSensorTable.query.filter(greenhouse_id = greenhouse_id).all()
...
def get_latest_reading(greenhouse_id):
    try:
        latest_reading = WindSensorTable.query.filter(greenhouse_id = greenhouse_id).order_by(WindSensorTable.timestamp.desc()).first()
